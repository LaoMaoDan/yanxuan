    ...
    <maskVue :dis="dis1" @editShow="editShow" height="580px">
      <div class="maskBox">
        <div class="head">
          ...
          <!-- <div class="currentDate">1990年1月</div> -->
          <div class="weekdays">
            <span>日</span>
            <span>一</span>
            <span>二</span>
        ...
        <div class="bottom" @touchstart.stop="up">
          <div class="bottom1" ref="bottom">
            <div v-for="(item, index) in Dates" :key="index" class="year">
              ...
              >
                ...
                <div class="days">
                  <div
                    @click.stop="acitve(index, index1, index2)"
                    ref="day"
                    :style="
                      item2 == 1
                        ? {
...
export default {
  ...
  methods: {
    ...
    getimg(e) {
      let d = e.target.d || e.dataTransfer.d;
    ...
    async submit() {
      ...
      formData.append("avatarurl", this.d);
    ...
    opencalendar() {
      ...
      this.$nextTick((_) => {
        el.style.transform = `translateY(${
          -el.clientHeight + el.children[0].children[0].clientHeight
        }px)`;
        this.preY = -el.clientHeight + el.children[0].children[0].clientHeight;
        this.moveY = -el.clientHeight + el.children[0].children[0].clientHeight;
      });
      this.getDate();
    },
    // 获取日期
    ...
    up(e) {
      ...
      let statrY = e.changedTouches[0].clientY;
      el.style.transtion = "all 0";
      el.addEventListener("touchmove", (e) => {
        this.moveY = this.preY + e.changedTouches[0].clientY - statrY;
        el.style.transform = `translateY(${this.moveY}px)`;
      });
      el.addEventListener("touchend", (e) => {
        el.style.transtion = "all .3s";
        if (this.moveY > 0) {
          this.moveY = 0;
        }
    ...
    acitve(year, month, day) {
      let el = this.$refs.bottom;
      if (this.prev.length) {
        el.children[this.prev[0]].children[this.prev[1]].children[1].children[
          this.prev[2]
        ].classList.remove("active");
      }

      el.children[year].children[month].children[1].children[day].classList.add(
        "active"
      );
