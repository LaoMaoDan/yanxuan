<template>
  <div class="box">
    ...
    <top-title :show="true" title="修改收货地址"></top-title>
    <div class="form">
      <div class="item">
        <span>姓名</span>
        <input
    ...
    <btnVue title="提交修改" @dian="addAddress"></btnVue>
...
import { postAddressedit } from "@/api/postAddressedit.js";
...
export default {
  ...
  methods: {
    ...
    left() {
      ...
      this.$refs.ballBox.style.background = "#eee";
      this.$refs.ballBox.style.borderColor = "#eee";
    ...
    async addAddress() {
      ...
      // 修改地址
      let res = await postAddressedit(this.userInfo);
      if (res.code == 200) {
        this.$message.show({
          title: res.msg,
          type: "success",
