          ...
          <div class="contentBox" ref="content">
            <div v-for="(item, index) in Dates" :key="index" class="year">
              ...
              >
                ...
                <div class="days">
                  <div
                    @click.stop="  year <= this.time[0] &&
          month <= this.time[1] &&
          day <= this.time[2] - 1? acitve(index, index1, index2)"
                    ref="day"
                    :style="
                      item2 == 1
                        ? {
    ...
    acitve(year, month, day) {
      ...
      setTimeout(() => {
        if (
          ...
          if (this.prev.length) {
            el.children[this.prev[0]].children[
              this.prev[1]
            ].children[2].children[this.prev[2]].classList.remove("active");
          }
