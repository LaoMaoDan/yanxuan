...
export default {
  ...
  methods: {
    ...
    startBottom() {
      ...
      let year =
        bottom.firstChild.firstChild.clientHeight -
        bottom.firstChild.lastChild.clientHeight;
      bottom.addEventListener("scroll", (e) => {
        if (e.target.scrollTop % year <= 10 && e.target.scrollTop % year >= 0) {
          let num = e.target.scrollTop / year;
          console.log(num);
        }
      });
    },
