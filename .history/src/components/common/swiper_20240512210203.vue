<template>
  <div class="swiperBox">
    <ul class="swiperUl" ref="ul">
      <li>
        <img v-if="getImg" :src="imgs[imgs.length - 1].img" alt="" />
        <img
          v-else
          :src="'http://43.138.15.137:4000//' + imgs[imgs.length - 1].img"
          alt=""
        />
      </li>
      <li
      ...
      <li>
        <img v-if="getImg" :src="imgs[0].img" alt="" />
        <img v-else :src="'http://43.138.15.137:4000//' + imgs[0].img" alt="" />
      </li>
    </ul>
  </div>
</template>
